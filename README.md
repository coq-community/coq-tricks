...
- Ltac is provided as a plugin loaded by the standard library; if you have `-noinit` to load it you need `Declare ML Module "ltac_plugin".`
  (see [NoInit.v](https://github.com/coq-community/coq-tricks/blob/main/src/NoInit.v)).
